...
exports.GetEditHome = (req, res, next) => {
     ...
     Home.fetchAll().then(([HomeData , schema])=>{
        const EditHomeData = HomeData.find((home) => {
          
            if (home._id === Number(req.params.homeid)) {
                console.log('if satuisfide: ' ,home._id)
                return home
            }
        })
        if (!EditHomeData) {
            ...
            res.render("host/edit-home", { home: EditHomeData, editing: req.query.editing === 'true' });
        }
    })
}
